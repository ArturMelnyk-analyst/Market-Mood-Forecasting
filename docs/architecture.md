...
Final Gradio app prototype with deployment to Hugging Face Spaces
...
  I --> K[Gradio Prototype — PR#9]
  K --> L[Hugging Face Spaces — PR#10]
...
  Root --> .env.example.txt[⚙️ .env.example.txt]
  Root --> .gitattributes[⚙️ .gitattributes]
...
PR#9: Gradio app for live risk prediction.

PR#10: Hugging Face Spaces deployment with public badge.
...
🗂️ architecture.md → This diagram & file map.
>>>>>>> a763882bcfe99c5b9707f0e675f3ba2461a6b90b
